...
- **[issue-workflow](plugins/issue-workflow/README.md)** — applies a generic clarify → issue → branch → validate → code pipeline to every Claude Code session, regardless of which repo it's running in.
...
claude plugin install issue-workflow@ai-harness
```
